...
function LogicPreview({
    ...
    const comparatorClassName = tone === "emerald"
        ? "border-emerald-500/20 bg-emerald-500/10 text-emerald-300"
        : "border-white/10 bg-white/[0.05] text-white";
    const valueClassName = tone === "emerald"
        ? "border-emerald-500/12 bg-emerald-500/[0.08] text-emerald-200"
                        ...
                        <div className="shrink-0 px-5 sm:px-8 pt-5 sm:pt-6">
                            <div className="grid grid-cols-5 gap-3">
                                {[1, 2, 3, 4, 5].map((currentStep) => (
                                    <div key={currentStep} className={`rounded-full h-1.5 transition-colors ${currentStep <= step ? "bg-emerald-400" : "bg-white/10"}`} />
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar p-5 sm:p-8 space-y-7">
                            {step === 1 ? (
                                <div className="space-y-8">
                                    <div className="rounded-3xl border border-emerald-500/15 bg-emerald-500/5 p-5 sm:p-6">
                                        <div className="flex items-start justify-between gap-4">
                                            <div>
                                                <p className="text-[10px] font-black text-emerald-300/70 uppercase tracking-[0.22em] mb-3">AI Magic</p>
                                            ...
                                            <button
                                                ...
                                                className="shrink-0 h-12 px-5 bg-white text-black rounded-xl font-bold text-xs uppercase tracking-[0.2em] hover:bg-emerald-50 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 shadow-xl disabled:opacity-70"
                                            >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex h-9 w-full items-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2 text-sm shadow-xs">
                                                <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-emerald-500/20 bg-emerald-500/10 text-emerald-300">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start justify-between gap-4">
                                        ...
                                        <button
                                            ...
                                            className="shrink-0 rounded-xl border border-dashed border-white/10 px-4 py-3 text-[10px] font-bold uppercase tracking-widest text-white/50 hover:text-emerald-300 hover:border-emerald-500/20 transition-all disabled:opacity-40"
                                        >
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1.5fr)_120px_180px_52px] items-stretch gap-3 p-3 sm:p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                                                                    ...
                                                                    <div className="flex items-center justify-between gap-3">
                                                                        ...
                                                                        <div className="text-right">
                                                                            <div className="flex items-center justify-end gap-2">
                                                                                {isLivePriceLoading ? <Loader2 className="h-3.5 w-3.5 animate-spin text-emerald-300/70" /> : null}
                                                                                <p className="text-sm font-mono font-black text-emerald-300">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Select value={condition.comparator} onValueChange={(value: "gte" | "lte") => updateCondition(index, { comparator: value })}>
                                                                <SelectTrigger className="w-full bg-black/20 border-white/10 rounded-xl h-14 text-sm font-mono text-emerald-400 font-bold justify-center px-0">
                                                                    <SelectValue />
                                                                </SelectTrigger>
                                                                <SelectContent className="bg-[#0a0a0c] border-white/10">
                                                                    <SelectItem value="gte" className="text-emerald-400 font-mono hover:bg-white/5 focus:bg-white/5 cursor-pointer">&gt;=</SelectItem>
                                                                    <SelectItem value="lte" className="text-emerald-400 font-mono hover:bg-white/5 focus:bg-white/5 cursor-pointer">&lt;=</SelectItem>
                                                                </SelectContent>
                                                            </Select>
                                    ...
                                    <div className="rounded-2xl border border-emerald-500/15 bg-[linear-gradient(180deg,rgba(16,185,129,0.08),rgba(255,255,255,0.01))] p-5">
                                        <div className="flex items-center justify-between gap-4 mb-4">
                                            <div>
                                                <p className="text-[9px] font-bold text-emerald-300/60 uppercase tracking-widest mb-2">Condition Preview</p>
                                        ...
                                        <div className="space-y-3">
                                            <LogicPreview conditions={draftConditions} tone="emerald" />
                                        </div>
                                    </div>
                                </div>
                            ) : null}
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="min-w-0 rounded-3xl border border-white/5 bg-white/[0.02] p-5 sm:p-6 space-y-4 overflow-hidden">
                                        <div className="flex items-center justify-between gap-4">
                                            ...
                                            <div className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] uppercase tracking-[0.2em] font-black text-emerald-300">
                                                {category}
                                            </div>
                                        </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-4 sm:p-5">
                                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                            ...
                                            <div className="inline-flex items-center gap-2 self-start rounded-full border border-emerald-500/15 bg-emerald-500/10 px-3 py-1.5">
                                                <span className="h-2 w-2 rounded-full bg-emerald-400" />
                                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-300">{isTestnet ? "Testnet" : "Mainnet"}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 border-t border-white/8 pt-4">
                                            <div className="flex items-start justify-between gap-4">
                                                ...
                                                <div className="shrink-0 rounded-full border border-emerald-500/15 bg-emerald-500/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-emerald-300">
                                                    {category}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 border-t border-white/8 pt-4">
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-300/65">Resolution Logic</p>
                                            <div className="mt-3">
                                                <LogicPreview conditions={draftConditions} tone="emerald" />
                                            </div>
                                        </div>
                        ...
                        <div className="shrink-0 px-5 sm:px-8 py-4 sm:py-6 border-t border-white/5 flex items-center justify-between gap-4 bg-[#0a0a0c]">
                            ...
                            <div className="flex items-center gap-3">
                                {createdTxHash ? (
                                    <button
                                        onClick={handleClose}
                                        className="h-12 px-6 bg-white text-black rounded-xl font-bold text-xs uppercase tracking-[0.2em] hover:bg-emerald-50 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 shadow-xl"
                                    >
                                        Done
                                    </button>
                                ) : step < TOTAL_STEPS ? (
                                    ...
                                    <button
                                        ...
                                        className="h-12 px-6 bg-white text-black rounded-xl font-bold text-xs uppercase tracking-[0.2em] hover:bg-emerald-50 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 shadow-xl disabled:opacity-70"
                                    >
                                        {isSubmitting ? (
                                            <>
