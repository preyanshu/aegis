...
export function MarketDetailView({ market, onBack, onMarketRefresh }: MarketDetailViewProps) {
    ...
    async function handleSubmitTally(position: BlindPositionRecord) {
        if (!stellarWallet || !walletPublic) {
            return;
        }

        setBusy(`tally-${position.commitment}`);
        setCommitError("");
        ...
        try {
            const proof = await generateTallyUpdateProof({
                ...
                previousTallyCommitment: market.tallyCommitment || `0x${"0".repeat(64)}`,
            });
            ...
            await onMarketRefresh?.();
            setStatus("Tally submitted and share packets uploaded. Auto-finalization is queued.");
        } catch (tallyError) {
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="rounded-[28px] border border-white/5 bg-white/[0.03] px-5 py-5 sm:px-6 sm:py-6">
                                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-white/25">Creator</p>
                    ...
                    <div className="bg-[#121214]/60 backdrop-blur-xl border border-white/5 p-5 sm:p-8 rounded-2xl sm:rounded-3xl">
                        ...
                        <div className="space-y-6">
                            ...
                            <button
                                ...
                                disabled={busy === "commit" || busy === "commit-submit" || market.resolved}
