            ...
            >
              <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8 md:mb-12">
                ...
                <button
                  ...
                  className="h-12 px-5 bg-white text-black rounded-xl font-bold text-xs uppercase tracking-[0.2em] hover:bg-emerald-50 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 shadow-xl"
                >
