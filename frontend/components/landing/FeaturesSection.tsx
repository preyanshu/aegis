    ...
    <section id="features" className="py-20 lg:py-32 px-6 max-w-7xl mx-auto">
        ...
        >
            <div className="max-w-3xl">
                <span className="text-primary text-sm font-medium mb-4 block tracking-wider uppercase">WHY AEGIS?</span>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white">
                    Privacy is the <br className="hidden md:block" /> market design.
                </h2>
            </div>
            <div className="lg:mb-4 w-full lg:w-auto">
                <p className="text-gray-400 text-base max-w-sm mb-8 text-left">
                    Built around blind commitments, oracle-settled markets, and portable private reputation.
                </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <FeatureCard
                ...
                desc="Side and size stay hidden."
                illustration={
            ...
            <FeatureCard
                index={1}
                title="5-Node Shamir Tally"
                desc="Five shards. One final aggregate."
                illustration={
                    <svg width="100%" height="100%" viewBox="0 0 240 100" fill="none">
            ...
            <FeatureCard
                index={2}
                title="Attested Private Reputation"
                desc="Real claims become proof-backed cards."
                illustration={
                    <svg width="100%" height="100%" viewBox="0 0 240 100" fill="none">
            ...
            <FeatureCard
                index={3}
                wide
                title="Dynamic Condition Oracle Architecture"
                desc="Each market carries its own oracle route, target, operator, and settlement time."
                illustration={
            ...
            <FeatureCard
                index={4}
                title="Dual-Mode User Vault"
                desc="Stay local or sync across devices."
                illustration={
                    <svg width="100%" height="100%" viewBox="0 0 240 100" fill="none">
